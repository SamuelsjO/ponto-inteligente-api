...
import com.samuelTI.pontointeligente.api.dtos.CadastroPFDto;
...
public class CadastroPFController {
	 ...
	 * @throws NoSuchAlgorithmException
	 */
	private Funcionario convertDtoByFuncionario(@Valid CadastroPFDto cadastroPFDto, BindingResult result) {
		...
		cadastroPFDto.getQtdHorasTrabalhoDia()
				.ifPresent(qtdHorasTrabDia -> funcionario.setQtHorasTrabalhadas_dia(Float.valueOf(qtdHorasTrabDia)));
